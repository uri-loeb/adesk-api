import os, re, time, base64, io, uuid, zipfile, json
...
def api_debug():
    return jsonify({
        "cookies": {k: request.cookies.get(k) for k in ["paid", "attempts"]},
...
def api_download():
    ...
    with zipfile.ZipFile(mem, "w", zipfile.ZIP_DEFLATED) as z:
        ...
        try:
            ...
            # write plain text safely (no syntax edge-cases)
