...
def make_svg_data_url(width: int, height: int, text: str) -> str:
    svg = f"""<svg xmlns='http://www.w3.org/2000/svg' width='{width}' height='{height}'>
      <defs><linearGradient id='g' x1='0' y1='0' x2='1' y2='1'>
        <stop offset='0%' stop-color='#eaf1ff'/><stop offset='100%' stop-color='#cfe4ff'/>
      </linearGradient></defs>
...
def create_checkout():
    try:
        checkout_session = stripe.checkout.Session.create(
            ...
            line_items=[{"price_data": {"currency": "usd", "product_data": {"name": "ADesk Access"}, "unit_amount": 500}, "quantity": 1}],
            mode="payment",
